...
# Batch_label = torch.tensor(encoder.fit_transform(meta_sub.Batch.values), dtype=torch.float)
# matrix_all.to_csv("H:/GOAT2.0-main/raw_data/GEA/expr.csv")
# meta_filter = meta_sub[['CancerType','Batch']]
# meta_filter.loc[:,'CancerType'] = label_all.numpy()
# meta_filter.loc[:,'Batch'] = Batch_label.numpy()
# meta_filter.to_csv("H:/GOAT2.0-main/raw_data/GEA/meta.csv")
...
for train_index, val_index in skf.split(matrix, label_list):
    ...
    trainer = create_trainer(max_epochs=1000, patience=500, min_delta=1e-4, log_dir="lightning_logs",
                             save_dir="checkpoints", experiment_name=f"heterogcn_{fold}")
    trainer.fit(model, train_loader, val_loader)
    trainer.test(model, test_loader)

model1_1 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_1/epoch=147-val_total_loss=0.5591.ckpt")
model1_2 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_1/epoch=136-val_total_loss=0.5640.ckpt")
model1_3 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_1/epoch=135-val_total_loss=0.5676.ckpt")

model2_1 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_2/epoch=89-val_total_loss=0.5169.ckpt")
model2_2 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_2/epoch=76-val_total_loss=0.5175.ckpt")
model2_3 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_2/epoch=73-val_total_loss=0.5151.ckpt")

model3_1 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_3/epoch=117-val_total_loss=0.5093.ckpt")
model3_2 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_3/epoch=113-val_total_loss=0.5039.ckpt")
model3_3 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_3/epoch=111-val_total_loss=0.5085.ckpt")

model4_1 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_4/epoch=77-val_total_loss=0.5042.ckpt")
model4_2 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_4/epoch=78-val_total_loss=0.5040.ckpt")
model4_3 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_4/epoch=82-val_total_loss=0.5166.ckpt")

model5_1 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_5/epoch=110-val_total_loss=0.3218.ckpt")
model5_2 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_5/epoch=160-val_total_loss=0.3272.ckpt")
model5_3 = GraphLevelHeteroGCN.load_from_checkpoint("checkpoints/heterogcn_5/epoch=157-val_total_loss=0.3291.ckpt")
...
df_ave_label0_PPI.to_csv("H:/Proteomic/gene_rank/rep/df_ave_label0_PPI.csv")
df_ave_label0_GRN.to_csv("H:/Proteomic/gene_rank/rep/df_ave_label0_GRN.csv")
df_ave_label1_PPI.to_csv("H:/Proteomic/gene_rank/rep/df_ave_label1_PPI.csv")
df_ave_label1_GRN.to_csv("H:/Proteomic/gene_rank/rep/df_ave_label1_GRN.csv")

# HPV_related
df_ave_label0_PPI = pd.read_csv("H:/Proteomic/gene_rank/df_ave_label0_PPI.csv", index_col=0).sort_values(by='0', ascending=False)
df_ave_label0_GRN = pd.read_csv("H:/Proteomic/gene_rank/df_ave_label0_GRN.csv", index_col=0).sort_values(by='0', ascending=False)
# EA_realted
df_ave_label1_PPI = pd.read_csv("H:/Proteomic/gene_rank/df_ave_label1_PPI.csv", index_col=0).sort_values(by='0', ascending=False)
df_ave_label1_GRN = pd.read_csv("H:/Proteomic/gene_rank/df_ave_label1_GRN.csv", index_col=0).sort_values(by='0', ascending=False)
